    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (response.groups && response.groups.length > 0) {
          ...
          // First page button
          paginationHtml += '<li class="page-item' + (page <= 1 ? ' disabled' : '') + '"><a class="page-link" href="javascript:void(0);" onclick="loadGroupTable(' + 1 + ', \'' + search + '\')"><i class="ti ti-chevrons-left"></i></a></li>';
          ...
          // Last page button
          paginationHtml += '<li class="page-item' + (page >= totalPages ? ' disabled' : '') + '"><a class="page-link" href="javascript:void(0);" onclick="loadGroupTable(' + totalPages + ', \'' + search + '\')"><i class="ti ti-chevrons-right"></i></a></li>';
